    ...
    return(
     ...
     transition={{duration : 1.5}}
      className=" h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center  " >
        ...
        <div className="w-1/4 flex space-x-5 items-center justify-center justify-between overflow-x-scroll p-10 overflow-hidden " >
        ...
        <Image src="/images/racket-2.png" alt="Description of the image" width={50} height={50} className=" hoverAnimation rounded-full border border-black-500 object-cover h-20 w-20 xl:w-20 xl:h-20 navbtn  "  />
